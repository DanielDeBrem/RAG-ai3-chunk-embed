...
BACKUP_DIR="backup_fix_ingest_lenient_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$BACKUP_DIR"
...
echo "[OK] main.py vervangen door een tolerante versie."
echo
echo "Herstart nu de datafactory op poort 9000:"
